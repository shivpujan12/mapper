  ...
  return (
    <div className={`${style.main}`}>
      ...
      <div className={`${style.rightPart}`}>
        ...
        <Image id="play" width={20} height={20} src="https://d1ehtu126lxvny.cloudfront.net/static/media/frontend/images/header/blue-right-arrow.svg" alt="play" />
        <div>Present</div>
        </div>
        ...
        <Image width={25} height={25} alt={"profile"} src="https://d1ehtu126lxvny.cloudfront.net/user/media/default/user.svg"/>
